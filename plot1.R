...
createplot1 <- function(dataURL = "https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip"){
        getdata(dataURL)
        makeplot1()
...
makeplot1 <- function() {
  png(filename="plot1.png", width=481, height=480)
